...
const durationInput = ref(props.clipDuration);
...
function handleGenerate(): void {
  const duration = durationInput.value ?? props.clipDuration;
...
<template>
  ...
  >
    ...
    <NSpace vertical :size="14">
      <div class="form-item">
        <label class="form-label">目标片段</label>
        <NInput :value="clipName" disabled placeholder="片段名称" />
      </div>
      ...
      <div class="form-item">
        ...
        <NSelect
          ...
          placeholder="请选择音乐风格"
          :menu-props="{ class: 'clip-music-select-dropdown' }"
        />
      </div>
...
/* 下拉菜单全局样式 - 只针对 clip-music-select-dropdown 类 */
:global(.clip-music-select-dropdown) {
  background: #2a2a32 !important;
...
:global(.clip-music-select-dropdown .n-base-select-option) {
  color: #eaeaef !important;
  background: transparent !important;
}

:global(.clip-music-select-dropdown .n-base-select-option::before) {
  background: transparent !important;
}

:global(.clip-music-select-dropdown .n-base-select-option--selected) {
  background: rgba(0, 212, 170, 0.12) !important;
  color: var(--accent, #00d4aa) !important;
  font-weight: 500 !important;
}

:global(.clip-music-select-dropdown .n-base-select-option--pending) {
  background: rgba(255, 255, 255, 0.06) !important;
  color: #ffffff !important;
}

:global(.clip-music-select-dropdown .n-base-select-option--selected.n-base-select-option--pending) {
  background: rgba(0, 212, 170, 0.18) !important;
  color: var(--accent, #00d4aa) !important;
}

:global(.clip-music-select-dropdown .n-base-select-group-header) {
  color: #8888a0 !important;
  font-weight: 600 !important;
}

:global(.clip-music-select-dropdown .n-base-select-group-divider) {
