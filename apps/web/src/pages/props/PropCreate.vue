...
import type { CreatePropDto } from "@pixaura/shared-types";
...
async function handleSubmit() {
  ...
  try {
    ...
    const response = await propStore.createProp(projectId, data);
    router.push(
      `/projects/${projectId}/props/${(response as unknown as { id: string }).id}`,
    );
  } finally {
    loading.value = false;
  }
